...
class FrontContainer extends \PrestaShop\PrestaShop\Adapter\Container\LegacyContainer
{
    ...
    {
        return $this->services['doctrine.dbal.default_connection'] = ${($_ = isset($this->services['doctrine.dbal.connection_factory']) ? $this->services['doctrine.dbal.connection_factory'] : ($this->services['doctrine.dbal.connection_factory'] = new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory([]))) && false ?: '_'}->createConnection(['driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => '', 'dbname' => 'agence bpm pro i2p', 'user' => 'root', 'password' => 'root', 'charset' => 'utf8mb4', 'driverOptions' => [1002 => 'SET sql_mode=(SELECT REPLACE(@@sql_mode,\'ONLY_FULL_GROUP_BY\',\'\'))'], 'defaultTableOptions' => []], new \Doctrine\DBAL\Configuration(), new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), ['enum' => 'string']);
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $d = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($c, [0 => 'C:\\laragon\\agence-bpm-i2p\\modules\\productcomments\\src\\Entity']);
        $d->addExcludePaths([0 => 'C:\\laragon\\agence-bpm-i2p\\modules\\productcomments\\src\\Entity/index.php']);
        $e = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($c, [0 => 'C:\\laragon\\agence-bpm-i2p\\modules\\ps_checkout\\src\\Entity']);
        $e->addExcludePaths([0 => 'C:\\laragon\\agence-bpm-i2p\\modules\\ps_checkout\\src\\Entity/index.php']);

        $b->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($c, [0 => 'C:\\laragon\\agence-bpm-i2p\\src\\PrestaShopBundle\\Entity']), 'PrestaShop');
        ...
        $a->setProxyDir('C:\\laragon\\agence-bpm-i2p/var/cache/prod\\/doctrine/orm/Proxies');
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_77efdf75a6db79e0cef685e97b035139193b2260cf22d3b035f7ca58c8206323');
    ...
    {
        return $this->services['prestashop.core.localization.cldr.cache.adapter'] = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('CLDR', 0, 'C:\\laragon\\agence-bpm-i2p/var/cache/prod\\/localization');
    }
    ...
    {
        $this->services['prestashop.core.localization.cldr.datalayer.locale_cache'] = $instance = new \PrestaShop\PrestaShop\Core\Localization\CLDR\DataLayer\LocaleCache(${($_ = isset($this->services['prestashop.core.localization.cldr.cache.adapter']) ? $this->services['prestashop.core.localization.cldr.cache.adapter'] : ($this->services['prestashop.core.localization.cldr.cache.adapter'] = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('CLDR', 0, 'C:\\laragon\\agence-bpm-i2p/var/cache/prod\\/localization'))) && false ?: '_'});
    ...
    {
        return $this->services['ps_checkout.cache.directory'] = new \PrestaShop\ModuleLibCacheDirectoryProvider\Cache\CacheDirectoryProvider('1.7.8.6', 'C:\\laragon\\agence-bpm-i2p', false);
    }
    ...
    {
        return $this->services['ps_checkout.logger.directory'] = new \PrestaShop\Module\PrestashopCheckout\Logger\LoggerDirectory('1.7.8.6', 'C:\\laragon\\agence-bpm-i2p');
    }
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'kernel.root_dir' => 'C:\\laragon\\agence-bpm-i2p/app',
            'kernel.project_dir' => 'C:\\laragon\\agence-bpm-i2p',
            'kernel.name' => 'app',
            'kernel.debug' => false,
            'kernel.environment' => 'prod',
            'kernel.cache_dir' => 'C:\\laragon\\agence-bpm-i2p/var/cache/prod\\',
            'kernel.active_modules' => [
                ...
                66 => 'ybc_blog_free',
                67 => 'ets_reviewticker',
                68 => 'ets_purchasetogether',
                69 => 'adesaform',
                70 => 'ps_emailsubscription',
                71 => 'ybc_newsletter',
                72 => 'ets_mailchimpsync',
                73 => 'ets_megamenu',
                74 => 'ets_multilayerslider',
                75 => 'pleasewait',
                76 => 'productcomments',
                77 => 'ybc_productimagehover',
                78 => 'ybc_themeconfig',
                79 => 'ybc_widget',
                80 => 'ybc_specificprices',
                81 => 'ybc_manufacturer',
                82 => 'ps_categorytree_mod',
                83 => 'mynewadesa',
            ],
            'ps_cache_dir' => 'C:\\laragon\\agence-bpm-i2p/var/cache/prod\\',
            ...
            'doctrine.orm.proxy_dir' => 'C:\\laragon\\agence-bpm-i2p/var/cache/prod\\/doctrine/orm/Proxies',
