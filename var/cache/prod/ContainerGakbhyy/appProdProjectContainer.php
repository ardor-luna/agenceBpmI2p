...
class appProdProjectContainer extends Container
{
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('copO94KGsb', 0, ($this->targetDirs[0].'/pools'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_1a0f463021d5c66534dd51f183f32487cc0fcc4a75011453dc9736b53ce7dea6');
    ...
    {
        return $this->services['fragment.listener'] = new \Symfony\Component\HttpKernel\EventListener\FragmentListener(${($_ = isset($this->services['uri_signer']) ? $this->services['uri_signer'] : ($this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('odgBRGpAO4PMUCFfVhGMe6e8s47o3Kbd8YNSOua854fcRJX9ZNsVf9hjqy7Ai2M4'))) && false ?: '_'}, '/_fragment');
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('odgBRGpAO4PMUCFfVhGMe6e8s47o3Kbd8YNSOua854fcRJX9ZNsVf9hjqy7Ai2M4');
    }
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'modules_translation_paths': $value = [
                ...
                59 => ($this->targetDirs[3].'/modules/ets_reviewticker/translations'),
                60 => ($this->targetDirs[3].'/modules/ps_emailsubscription/translations'),
                61 => ($this->targetDirs[3].'/modules/ybc_newsletter/translations'),
                62 => ($this->targetDirs[3].'/modules/ets_mailchimpsync/translations'),
                63 => ($this->targetDirs[3].'/modules/ets_megamenu/translations'),
                64 => ($this->targetDirs[3].'/modules/ets_multilayerslider/translations'),
                65 => ($this->targetDirs[3].'/modules/pleasewait/translations'),
                66 => ($this->targetDirs[3].'/modules/productcomments/translations'),
                67 => ($this->targetDirs[3].'/modules/ps_categorytree_mod/translations'),
            ]; break;
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'kernel.secret' => 'odgBRGpAO4PMUCFfVhGMe6e8s47o3Kbd8YNSOua854fcRJX9ZNsVf9hjqy7Ai2M4',
