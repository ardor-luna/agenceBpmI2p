    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'modules_translation_paths': $value = [
                ...
                56 => ($this->targetDirs[3].'/modules/ps_specials/translations'),
                57 => ($this->targetDirs[3].'/modules/ps_newproducts/translations'),
                58 => ($this->targetDirs[3].'/modules/ps_viewedproduct/translations'),
                59 => ($this->targetDirs[3].'/modules/ybc_blog_free/translations'),
