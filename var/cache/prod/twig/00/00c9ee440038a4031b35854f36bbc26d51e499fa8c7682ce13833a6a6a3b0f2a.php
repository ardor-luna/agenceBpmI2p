...
$context["action"], "type", [], "any", true, true) && ($this->getAttribute($context["action"], "type", []) == "button"))) {
    ...
    {
        return new Source("", "PrestaShopBundle:Admin/Helpers:bootstrap_popup.html.twig", "C:\\laragon\\agence-bpm-i2p\\src\\PrestaShopBundle/Resources/views/Admin/Helpers/bootstrap_popup.html.twig");
    }
}
