    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'modules_translation_paths': $value = [
                ...
                60 => ($this->targetDirs[3].'/modules/ets_mailchimpsync/translations'),
                61 => ($this->targetDirs[3].'/modules/ets_megamenu/translations'),
                62 => ($this->targetDirs[3].'/modules/ets_multilayerslider/translations'),
                63 => ($this->targetDirs[3].'/modules/pleasewait/translations'),
                64 => ($this->targetDirs[3].'/modules/productcomments/translations'),
                65 => ($this->targetDirs[3].'/modules/ps_categorytree_mod/translations'),
            ]; break;
